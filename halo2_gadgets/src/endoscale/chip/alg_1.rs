    ...
    C::Base: PrimeFieldBits,
{
    pub(super) fn configure(
        ...
        let q_double_and_add = meta.selector();
        // Final double-and-add gate
        let q_double_and_add_final = meta.selector();

        let double_and_add = DoubleAndAdd::configure(meta, x_a, x_p, lambda_1, lambda_2, &|meta| {
